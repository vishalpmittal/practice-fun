...
public class P070_ClimbingStairs {
	 ...
	 * Hint: the tag also suggests that! Here are the steps to get the solution incrementally.
	 * 
	 * Base cases:
	 * if n <= 0, then the number of ways should be zero. if n == 1, then there is 
	 * only way to climb the stair. if n == 2, then there are two ways to climb the stairs.
	 ...
	 * the solution for each number n. Or if we look at it closer, it is clear that this
	 * is basically a fibonacci number, with the starting numbers as 1 and 2, instead of 1 and 1.
	 */
