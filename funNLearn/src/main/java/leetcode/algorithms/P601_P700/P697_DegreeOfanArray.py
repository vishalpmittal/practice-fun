...
class Solution:
    def findShortestSubArray(self, nums: List[int]) -> int:
        # get the left most and right most location of the degree number.
        # the shortest subarray with same degree will be right-left+1
        # compare that for all the numbers
        left, right, count = {}, {}, {}
