...
class Solution:
    ...
    def isRectangleOverlap_1(self, rec1: List[int], rec2: List[int]) -> bool:
...
assert Solution().isRectangleOverlap(rec1=[0, 0, 2, 2], rec2=[1, 1, 3, 3])
assert not Solution().isRectangleOverlap(rec1=[0, 0, 1, 1], rec2=[1, 0, 2, 1])
print('Tests Passed!!')
