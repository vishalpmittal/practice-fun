"""
    ...
    items in arr1 are the same as in arr2.  Elements that 
    don't appear in arr2 should be placed at the end of 
...
class Solution:
    def relativeSortArray(self, arr1: List[int], arr2: List[int]) -> List[int]:
        ...
        return sorted(arr1, key=lambda x: D.get(x, x+len(arr2)))
