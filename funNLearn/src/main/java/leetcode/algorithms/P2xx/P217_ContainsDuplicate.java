...
public class P217_ContainsDuplicate {
	 ...
	 * The naive approach would be to run a iteration for each element and 
	 * see whether a duplicate value can be found: this results in O(N^2) 
	 * time complexity.
	 */
	 ...
	 * we can sort it as the first step of the algorithm and then search 
	 ...
	 * Finally we can used a well known data structure hash table that 
	 * will help us to identify whether an element has been previously 
