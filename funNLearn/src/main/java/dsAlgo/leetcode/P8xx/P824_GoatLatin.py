"""
    ...
    Example 1: Input: "I speak Goat Latin" Output: "Imaa peaksmaaa oatGmaaaa atinLmaaaaa"

    Example 2: Input: "The quick brown fox jumped over the lazy dog"
...
op = "Imaa peaksmaaa oatGmaaaa atinLmaaaaa"
assert Solution().toGoatLatin(ip) == op
print('Tests Passed!!')
