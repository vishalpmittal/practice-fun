"""
    ...
    2 candies to the second person, and so on until we give 
    ...
    of our remaining candies (not necessarily one more than the 
    previous gift).

    Return an array (of length num_people and sum candies) 
    that represents the final distribution of candies.

    Example 1: Input: candies = 7, num_people = 4 Output: [1,2,3,1]
    Explanation:
    ...
    Example 2: Input: candies = 10, num_people = 3 Output: [5,2,3]
    Explanation:
