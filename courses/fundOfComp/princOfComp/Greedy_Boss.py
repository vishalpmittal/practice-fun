...
def greedy_boss(days_in_simulation, bribe_cost_increment, plot_type = STANDARD):
    ...
    global SALARY_INCREMENT
    global INITIAL_BRIBE_COST
    
    # initialize necessary local variables
    salary_per_day = INITIAL_SALARY
    ...
    days_vs_earnings = [(current_day, total_salary_paid)]
    ...
    while current_day <= days_in_simulation:
        ...
        while(current_savings < bribe_cost):
            current_day+=1
            current_savings += salary_per_day
            total_salary_paid += salary_per_day
        
        # update state of simulation to reflect bribe
        salary_per_day += SALARY_INCREMENT
        current_savings -= bribe_cost
        bribe_cost += bribe_cost_increment

        # update list with days vs total salary earned for most recent bribe
        # use plot_type to control whether regular or log/log plot
        if plot_type == STANDARD:
            days_vs_earnings.append((current_day, total_salary_paid))
        else:
            days_vs_earnings.append((math.log(current_day), math.log(total_salary_paid)))
...
# should print [(0, 0), (10, 1000), (16, 2200), (20, 3400), (23, 4600), 
#(26, 6100), (29, 7900), (31, 9300), (33, 10900), (35, 12700), (37, 14700)]

print greedy_boss(35, 0)
# should print [(0, 0), (10, 1000), (15, 2000), (19, 3200), (21, 4000), 
#(23, 5000), (25, 6200), (27, 7600), (28, 8400), (29, 9300), (30, 10300), 
#(31, 11400), (32, 12600), (33, 13900), (34, 15300), (34, 15300), 
#(35, 16900), (36, 18600)]
