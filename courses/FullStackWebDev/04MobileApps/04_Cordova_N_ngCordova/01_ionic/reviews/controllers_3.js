...
.controller('AppCtrl', function($scope, $ionicModal, $timeout, $localStorage, $ionicPlatform, $cordovaCamera, $cordovaImagePicker) {
  ...
  // Create the registration modal that we will use later
    ...
    $scope.doRegister = function () {
        console.log('Doing registration', $scope.registraion);
...
.controller('DishDetailController', ['$scope', 'dish', '$stateParams', 'menuFactory', 'baseURL', '$ionicPopover', 'favoriteFactory', '$ionicModal', '$ionicPlatform', '$cordovaLocalNotification', '$cordovaToast',
    function($scope, dish, $stateParams, menuFactory, baseURL, $ionicPopover, favoriteFactory, $ionicModal, $ionicPlatform, $cordovaLocalNotification, $cordovaToast) {
...
//    $scope.leaders = corporateFactory.query();
    ...
    $scope.leaders = [];
    for(i = 0; i < 4; i++) {
        $scope.leaders.push(corporateFactory.get({id:i}));
    }
    */
