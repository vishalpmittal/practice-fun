  ...
  $ionicPlatform.ready(function() {
    ...
    $scope.selectPicture = function () {
      ...
      .then(function(result) {
        // casting to string to avoid problem with path
        $scope.registration.imgSrc = result.toString();
      }, function(err) {
        console.log(err);
      });
      $scope.registerform.show();
...
.controller('DishDetailController', ['$scope', '$stateParams', 'dish', 'menuFactory', 'baseURL', '$ionicPopover', 'favoriteFactory', '$ionicModal', '$ionicPlatform', '$cordovaLocalNotification', '$cordovaToast', function($scope, $stateParams, dish, menuFactory, baseURL, $ionicPopover, favoriteFactory, $ionicModal, $ionicPlatform, $cordovaLocalNotification, $cordovaToast) {
  ...
  // Add to favorites function. I use the scope value for the dish because I had problems using the value from the popover. I was getting undefined values and the corrent ones for no particular reason I can see.
  ...
  //Comment form implementation and related function
  ...
  // I cast the rating to an integer value because it gets added as a string by default, making the ordering function useless when using rating as our criteria.
...
.controller('DishCommentController', ['$scope', 'menuFactory', function($scope,menuFactory) {
  ...
  $scope.submitComment = function () {
    ...
    menuFactory.update({id:$scope.dish.id},$scope.dish);
    $scope.commentForm.$setPristine();$scope.mycomment = {rating:5, comment:"", author:"", date:""};
  }
}])
