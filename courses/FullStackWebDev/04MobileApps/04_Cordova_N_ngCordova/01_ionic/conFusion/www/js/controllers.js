...
.controller('DishDetailController', ['$scope', '$stateParams', 'dish', 'menuFactory', 'favoriteFactory', 'baseURL', '$ionicPopover', '$ionicModal', '$ionicPlatform', '$cordovaLocalNotification', '$cordovaToast', function ($scope, $stateParams, dish, menuFactory, favoriteFactory, baseURL, $ionicPopover, $ionicModal, $ionicPlatform, $cordovaLocalNotification, $cordovaToast) {
    ...
    $scope.openDDPopover = function ($event) {
        $scope.popover.show($event);
    };

    $scope.closeDDPopover = function () {
        $scope.popover.hide();
    };

    $scope.addFavorite = function () {
        favoriteFactory.addToFavorites($scope.dish.id);
        $scope.closeDDPopover();
    ...
    // -----------------------------------------------------------
    // Dish comment form modal
    // -----------------------------------------------------------
    // Create the dish comments modal that we will use later
    ...
    $scope.submitDishComment = function () {
        ...
        console.log($scope.newDishComment);
    ...
    $scope.deleteFavorite = function (index) {
        ...
        confirmPopup.then(function (res) {
            if (res) {
                ...
                // Vibrate 100ms    
                $ionicPlatform.ready(function () {
                    console.log("Vibrating for 1000 ms as favorite deleted");
