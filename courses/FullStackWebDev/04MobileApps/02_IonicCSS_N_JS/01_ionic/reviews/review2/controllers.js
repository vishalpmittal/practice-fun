      ...
      $scope.closeReserve();
       ...
       .controller('MenuController', ['$scope', 'menuFactory', 'favoriteFactory', 'baseURL', '$ionicListDelegate', function ($scope, menuFactory, favoriteFactory, baseURL, $ionicListDelegate) {
        ...
        .controller('DishDetailController', ['$scope', '$stateParams','favoriteFactory', 'menuFactory', 'baseURL','$ionicPopover','$ionicModal', function($scope, $stateParams,favoriteFactory, menuFactory, baseURL,$ionicPopover,$ionicModal) {
            ...
            $scope.DishDetailpopover = function () {
                $scope.shouldShowpopover = !$scope.shouldShowpopover;
                console.log($scope.shouldShowpopover);                
            }
           ...
           $scope.$on('popover.removed', function() {
            ...
            $ionicModal.fromTemplateUrl('templates/dish-comment.html', {
                ...
                $scope.insertCommentForm = modal;
              });

              // Triggered in the reserve modal to close it
              $scope.closecomment = function() {
                $scope.insertCommentForm.hide();
              };

              // Open the reserve modal
              $scope.insertComment = function() {
                  $scope.closePopover();
                $scope.insertCommentForm.show();
              };
