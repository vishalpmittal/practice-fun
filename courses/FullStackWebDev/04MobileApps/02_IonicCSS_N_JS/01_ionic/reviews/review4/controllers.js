...
.controller('DishDetailController', ['$scope', '$stateParams', 'menuFactory', 'favoriteFactory','baseURL', '$ionicListDelegate', '$ionicPopover', '$ionicModal', '$ionicLoading', '$timeout', function($scope, $stateParams, menuFactory, favoriteFactory, baseURL, $ionicListDelegate,$ionicPopover, $ionicModal, $ionicLoading, $timeout) {
  $scope.baseURL = baseURL;
  ...
  $scope.doComment = function() {
    $ionicLoading.show({
      template: '<ion-spinner></ion-spinner> Adding your Comment...'
    });
    $timeout(function () {
      $ionicLoading.hide();
    }, 1000);
