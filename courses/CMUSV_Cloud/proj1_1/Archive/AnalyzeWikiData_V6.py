file = open("pagecounts-20150801-000000_bkp","r")
all_lines =[]
output =[]
...
for all_lines in range(0, len(all_lines)):
 	el= all_lines.split(' ') 
 	print el
 	all_lines.append(el[1]+el[0])
 	print all_lines
for myLine in all_lines:
	print myLine
#  	output =output.append(all_lines[1]+"/"+all_lines[0])
